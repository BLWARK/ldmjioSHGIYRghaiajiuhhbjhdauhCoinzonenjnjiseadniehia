            ...
            <div className="p-4">
              <div className="flex flex-wrap gap-2 mb-2">
                {event.tags.map((tag, idx) => (
                  <span
                    key={idx}
                    className="bg-orange-200 text-orange-700 px-2 py-1 text-xs rounded"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <p className="text-[12px] text-gray-600 mb-2">
                <span className="font-semibold">{event.date}</span> ({event.timezone})
              </p>
              <p className="text-[12px] text-gray-600 mb-2">{event.location}</p>
